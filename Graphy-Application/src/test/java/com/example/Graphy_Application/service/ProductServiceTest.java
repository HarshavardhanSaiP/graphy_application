...
public class ProductServiceTest {
    ...
    void testGetProductsByCategoryAndPriceRange_FoundProducts() {
        ...
        List<ProductResponse> products = productService.getProductsByCategoryAndPriceRange("Electronics", 50, 150);
        ...
        assertTrue(products.contains(ProductMapper.toResponse(product1)), "Product list should contain Product1");
        assertTrue(products.contains(ProductMapper.toResponse(product2)), "Product list should contain Product2");
